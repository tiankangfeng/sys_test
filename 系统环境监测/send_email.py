...
try:
    ...
    reveivers = "2310969783@qq.com,kangfeng@gmail.com"
    ...
    smtp_server.sendmail("315552758@qq.com", ["2310969783@qq.com", "kangfeng@gmail.com"], content.as_string())  # 第一个参数：发送者的邮箱账号；第二个参数是个列表类型，每个元素为一个接收者；第三个参数：邮件内容
