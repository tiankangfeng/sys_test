...
def send_email():
    ...
    try:
        ...
        reveivers = "1126@aliyun.com,ng@gmail.com,24@qq.com,62@qq.com,783@qq.com"
        content['To'] = reveivers  # 设置邮件的接收者，多个接收者之间用逗号隔开
        content['From'] = str("52758@qq.com")  # 邮件的发送者,最好写成str("这里填发送者")，不然可能会出现乱码
        ...
        smtp_server.login("758@qq.com", "")  # 第一个参数：发送者的邮箱账号 第二个参数：对应邮箱账号的密码

        smtp_server.sendmail("758@qq.com", ["126@aliyun.com", "g@gmail.com","24@qq.com","62@qq.com","783@qq.com"], content.as_string())  # 第一个参数：发送者的邮箱账号；第二个参数是个列表类型，每个元素为一个接收者；第三个参数：邮件内容
