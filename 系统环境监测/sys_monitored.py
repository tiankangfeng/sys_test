...
def send_email():
    ...
    try:
        ...
        reveivers = "lm0721126@aliyun.com,kangfeng@gmail.com,348287224@qq.com,87389162@qq.com,2310969783@qq.com"
        ...
        smtp_server.login("315552758@qq.com", "")  # 第一个参数：发送者的邮箱账号 第二个参数：对应邮箱账号的密码

        smtp_server.sendmail("315552758@qq.com", ["lm0721126@aliyun.com", "kangfeng@gmail.com","348287224@qq.com","87389162@qq.com","2310969783@qq.com"], content.as_string())  # 第一个参数：发送者的邮箱账号；第二个参数是个列表类型，每个元素为一个接收者；第三个参数：邮件内容
